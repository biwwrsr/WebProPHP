...
<body>
    <center>
        ...
        <form>
            <?php
/*โชว์ค่าค้างไว้*/  if (isset($_GET['submit'])) {
/*num1*/            echo "Num 1 : <input type=text name=number1  value=$number1><br><br>";
                    if ($operator1 == "+") {
...
/*num2*/            echo "Num 2 : <input type=text name=number2 value=$number2><br><br>";
                    if ($operator2 == "+") {
